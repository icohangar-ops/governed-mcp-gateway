 ...
 *
 * Import compiled JS from `dist/` (`npm run build`). Do not load TypeScript
 * via runtime tsx — Fluid/Node cannot ship tsx's CJS helper.
 */

import { handleWebRequest } from "../dist/web.mjs";
